...
namespace Portal
{
    class Program
    {
        ...
        private static ICurrencyExchangeService _exchangeService = new CurrencyExchangeService(
            new CurrenciesApiCacheService(new RubCurrenciesApi()),
        ...
        static async Task Main(string[] args)
        {
            ...
            var result1 = await _exchangeService.ConvertFromLocal(100, "USD");
            Console.WriteLine("1: " + result1);
            var result2 = await _exchangeService.ConvertToLocal(1000, "RUB");
